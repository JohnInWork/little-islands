...
- 40 навыков в фундаменте, 24 рабочих: восемь разведки, восемь боевых техник по
  семействам оружия, четыре школы магии и вся ветка выживания; очко за уровень
  по выбору игрока.
...
- Некромантия занимает слоты заклинаний: в каждом занятом слоте ходит поднятый
  слуга, который дерётся, заслоняет героя и сам встаёт снова после гибели.
- Лестницы работают в обе стороны: каждый пройденный этаж помнит открытые
  двери, убитых врагов и унесённый лут, поэтому наверх можно вернуться.
