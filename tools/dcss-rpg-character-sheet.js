...
import { HUNGER_MAX, hungerPresentation, validateHunger } from './dcss-rpg-hunger.js';
...
export function characterSheetModel({
  ...
  const hunger = hungerPresentation(validateHunger(hero.hunger) ? hero.hunger : HUNGER_MAX, locale);
