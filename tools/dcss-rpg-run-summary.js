...
export const RUN_END_SOURCE_NAMES = Object.freeze({
  ...
  ogre: pair('Огр', 'Ogre'),
  'grave-shade': pair('Могильная тень', 'Grave shade'),
  'bone-knight': pair('Костяной рыцарь', 'Bone knight'),
  'crypt-revenant': pair('Выходец', 'Revenant'),
  'profane-servitor': pair('Осквернённый служитель', 'Profane servitor'),
  'eidolon': pair('Эйдолон', 'Eidolon'),
  'shadow-wraith': pair('Теневой призрак', 'Shadow wraith'),
  'tomb-warden': pair('Смотритель гробниц', 'Tomb warden'),
  'bone-dragon': pair('Костяной дракон', 'Bone dragon'),
  'ancient-lich': pair('Древний лич', 'Ancient lich'),
  'blue-devil': pair('Синий дьявол', 'Blue devil'),
  'demonic-crawler': pair('Демонический ползун', 'Demonic crawler'),
  'hellion': pair('Геенник', 'Hellion'),
  'blizzard-demon': pair('Демон вьюги', 'Blizzard demon'),
  'executioner': pair('Палач', 'Executioner'),
  'brimstone-fiend': pair('Серный исчадие', 'Brimstone fiend'),
  'shadow-fiend': pair('Теневое исчадие', 'Shadow fiend'),
  'ice-devil': pair('Ледяной дьявол', 'Ice devil'),
  'hell-lord': pair('Владыка ада', 'Hell lord'),
