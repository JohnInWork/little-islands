...
const COPY = Object.freeze({
  ru: Object.freeze({
    ...
    graveClosed: '',
    graveInspected: 'На плите тёмная печать. Внутри золото мёртвых, но печать ранит того, кто вскроет, а иногда встаёт и сам мёртвый.',
  ...
  en: Object.freeze({
    ...
    graveClosed: '',
    graveInspected: 'A dark seal marks the slab. The dead keep gold; the seal wounds whoever breaks it, and sometimes the dead rise.',
