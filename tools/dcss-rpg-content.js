...
export const LOOT_CATALOG = Object.freeze([
  ...
  },
  {
    ...
    weight: 8,
    minDepth: 1,
    // Три, а не две: на восемнадцать сундуков за забег выпадало около шести
    // отмычек, и даже мастер взлома открывал лишь треть. Вес не тронут —
    // случайный лут на сохранённых этажах остаётся прежним.
    stack: 3,
