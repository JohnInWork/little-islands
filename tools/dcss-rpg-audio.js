...
export const MUSIC_SAMPLES = Object.freeze({
  ...
  surface: sample('music/field.mp3', 0.06),
  deep: sample('music/cave.mp3', 0.06),
  vaults: sample('music/town.mp3', 0.06),
  crypt: sample('music/crypt.mp3', 0.05),
  // Ад громче прочих ровно настолько, насколько он и должен быть слышнее: это
  // единственная дорога, где мелодия не фон, а предупреждение.
  hell: sample('music/hell.mp3', 0.07),
  /*
   * Бой со стражем — не дорога, а событие, и звучит громче всех.
   *
   * Ключ `boss` дороге не принадлежит: его возвращает тот же `musicRoad`, когда
   * страж главы заметил героя. Кончился бой — ключ снова становится дорогой, и
