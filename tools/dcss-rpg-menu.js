...
const COPY = Object.freeze({
  ru: Object.freeze({
    ...
    labels: Object.freeze({
      ...
      noHair: 'Без волос',
      beard: 'Борода',
      previousBeard: 'Предыдущая борода',
      nextBeard: 'Следующая борода',
      ...
      // Стереть прогресс — единственное необратимое действие в меню, поэтому
      // кнопка спрашивает второй раз, а не полагается на твёрдость руки.
      wipeTitle: 'Начать всё сначала',
      wipeNote: 'Удалит записи, рекорды и текущий забег. Отменить нельзя.',
      wipe: 'Стереть прогресс',
      wipeConfirm: 'Точно стереть?',
      wipeDone: 'Стёрто',
      credits: 'Авторы',
      openCredits: 'Открыть авторов',
  ...
  en: Object.freeze({
    ...
    labels: Object.freeze({
      ...
      noHair: 'No hair',
      beard: 'Beard',
      previousBeard: 'Previous beard',
      nextBeard: 'Next beard',
      appearanceDone: 'Done',
      newRun: 'New run',
      ...
      wipeTitle: 'Start over',
      wipeNote: 'Erases records, high scores and the current run. This cannot be undone.',
      wipe: 'Erase progress',
      wipeConfirm: 'Erase for good?',
      wipeDone: 'Erased',
      credits: 'Credits',
