...
export function merchantPresentation(variantId, language = 'ru') {
  ...
  return Object.freeze({
    ...
    poor: locale === 'ru' ? 'Недостаточно реального золота' : 'Not enough real gold',
    merchantPoor: locale === 'ru' ? 'У торговца мало реального золота' : 'Merchant is short on real gold',
    merchantFull: locale === 'ru' ? 'Торговец больше не принимает вещи' : 'Merchant cannot hold more items',
    playerGold: locale === 'ru' ? 'Твоё реальное золото' : 'Your real gold',
