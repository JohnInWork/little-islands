  ...
  section({
    ...
    ru: {
      ...
      entries: [
        ...
        entry('Лечение', 'Зелья, еда и заклинания очищения. Каменный алтарь лечит за золото: он есть в городе, а в подземелье попадается редко.'),
      ],
    },
    en: {
      title: 'Survival',
      entries: [
        ...
        entry('Healing', 'Potions, food and cleansing spells. The stone altar heals for gold: there is one in town, and they are rare below.'),
      ],
    },
  }),
  section({
