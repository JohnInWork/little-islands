  ...
  section({
    ...
    ru: {
      ...
      entries: [
        ...
        entry('Лечение', 'Зелья, еда, заклинания очищения и каменный алтарь на этаже: он лечит за немного золота.'),
      ],
    },
    en: {
      title: 'Survival',
      entries: [
        ...
        entry('Healing', 'Potions, food, cleansing spells and the stone altar on a floor: it heals you for a little gold.'),
      ],
    },
  }),
  section({
