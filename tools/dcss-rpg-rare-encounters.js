...
/**
 * Кто выглядит как сам герой.
 *
 * Мара показывает пришедшему его самого — в его же снаряжении и с его же
 * оружием. Картинки у неё поэтому нет: она собирается из тех же слоёв, что и
 * герой, и рисуется отдельно от всех остальных, как призрак прошлого забега.
 * Спрайт из каталога остаётся как запасной — для карточки и всплывающей
 * подписи, где фигуру собирать не из чего.
 */
export const DOUBLE_MONSTER_ID = 'mara';
