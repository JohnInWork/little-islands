...
test('v12 reload retains open doors, and reclosing does not rearm surprise encounters', () => {
  ...
  assert.equal(SAVE_VERSION, 12, 'interactive find state is persisted in v12');
});
